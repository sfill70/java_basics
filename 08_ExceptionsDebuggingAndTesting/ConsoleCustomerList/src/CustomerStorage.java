...
public class CustomerStorage {
    ...
    public void addCustomer(String data) throws ArrayIndexOutOfBoundsException, NameFormatException {
    ...
    private void checkName(String[] components) throws NameFormatException {
        ...
        if (!components[0].matches(NAME) || !components[1].matches(NAME)) {
    ...
    private void checkPhone(String[] components) throws PhoneFormatException {
        ...
        if (!components[3].trim().replaceAll("[^0-9]", "").matches(PHONE)) {
