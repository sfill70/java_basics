...
public class Load {
    ...
    public static void main(String[] args) {
        ...
        suffixTree.build();
        List<Integer>integerList = suffixTree.getPositionsSt("как");
        System.out.println(integerList);
        System.out.println(string.substring(integerList.get(0), integerList.get(0) + "как".length()));
        List<String>list = suffixTree.search("живет");
